...
// Componente simplificado DashboardLayout
function SimpleDashboardLayout({ 
  title, 
  subtitle, 
  children 
}: { 
...
// Componente simplificado DateRangeFilter
function SimpleDateRangeFilter({ 
  fechaInicio, 
  fechaFin, 
  onFechaInicioChange, 
  onFechaFinChange, 
...
export default function Test6FulfillmentPage() {
    ...
    try {
      ...
      const mockData = {
        ...
        pedidosPorDia: [
          ...
          { date: '2024-01-04', pedidos: 61, faltantes: 2 },
          { date: '2024-01-05', pedidos: 43, faltantes: 4 },
          { date: '2024-01-06', pedidos: 55, faltantes: 6 },
          { date: '2024-01-07', pedidos: 47, faltantes: 3 },
        ],
        estadoFulfillment: [
        ...
        productosConShortage: [
          ...
          { name: 'Producto D', shortage: 6 },
          { name: 'Producto E', shortage: 4 },
        ]
      };
  ...
  return (
    <SimpleDashboardLayout
      title="FullFillment - Versión Test 6 (Componentes)"
      subtitle="Panel de control con componentes personalizados"
    >
      <SimpleDateRangeFilter
        ...
        onApply={() => {
          // Aquí podrías elegir entre API real o simulada
          handleConsultaSimulada();
        }}
        loading={loading}
      />
      ...
      {data && (
        <>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
            ...
            {/* Gráfico de Pie - Estado de Fulfillment */}
            <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
              <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">
              ...
              <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                  <Pie
                    ...
                    dataKey="value"
                  >
                    {data.estadoFulfillment.map((entry: any, index: number) => (
          ...
          {/* Gráfico de Barras - Productos con Shortage */}
          <div className="bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700 mb-8">
            <h2 className="text-xl font-semibold mb-4 text-gray-900 dark:text-gray-100">
      ...
      <div className="mt-8 bg-white dark:bg-gray-800 rounded-lg shadow p-6 border border-gray-200 dark:border-gray-700">
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between p-4 bg-green-50 dark:bg-green-900/20 rounded-lg">
            ...
            <span className="text-green-600 dark:text-green-400 text-sm">Versión test 6 activa</span>
          </div>
          
          <div className="flex items-center justify-between p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <span className="text-blue-800 dark:text-blue-200 font-medium">🧩 Componentes personalizados</span>
            <span className="text-blue-600 dark:text-blue-400 text-sm">Simplificados</span>
          </div>
          
          <div className="flex items-center justify-between p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
            <span className="text-purple-800 dark:text-purple-200 font-medium">🎯 Muy cerca</span>
            <span className="text-purple-600 dark:text-purple-400 text-sm">Casi listo</span>
          </div>
        </div>
      </div>
    </SimpleDashboardLayout>
