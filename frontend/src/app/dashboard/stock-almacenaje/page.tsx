            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-8">
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <InfoTooltip text="Cantidad de pallets en cada sector (foto vigente)." />
                </div>
              ...
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <InfoTooltip text="Cantidad de pallets por sección del almacén (foto vigente)." />
                </div>
                <ResponsiveContainer width="100%" height={320}>
            ...
            {data.graficos.contenedoresPorCanal && data.graficos.contenedoresPorCanal.length > 0 && (
              <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6 border border-gray-200 dark:border-gray-700">
                <div className="mb-4 flex items-center gap-2">
                  ...
                  <InfoTooltip text={'% y cantidad de contenedores por tipo de canal operativo (excluye "Sin canal").'} />
                </div>
                <div className="relative">
